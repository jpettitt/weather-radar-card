...
| show_lightning            | boolean         | **Optional**   | Overlay live lightning strikes from the [Blitzortung integration](https://www.home-assistant.io/integrations/blitzortung/) (see [Hazard Overlays](overlays.md#lightning-blitzortung))                                                                  | `false`                               |
